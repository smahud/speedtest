...
#   script ini otomatis mengunduh file pendukung (common + bagian0..8 +
#   ooklaserver.sh + uninstall.sh) ke BASE_DIR dari repository,
#   lalu menjalankannya.
###############################################################################
set -euo pipefail
...
# Speedtest Install State - generated by install.sh
...
log_info "Cleanup script  : $BASE_DIR/uninstall.sh"
log_info ""
...
log_info ""
log_info "Untuk cleanup total (kecuali data.ini):"
log_info "  bash $BASE_DIR/uninstall.sh"
print_hash 50
